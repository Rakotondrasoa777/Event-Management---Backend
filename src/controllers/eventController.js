...
const eventController = {
    ...
    getEventById: async(req, res) => {
        ...
        let sql = "select e.id, e.title, e.date_of_event, e.categorie, e.description, e.location, e.available_of_ticket, ts.price, ts.type_of_ticket from event e join ticket_stock ts on e.id = ts.id_event where e.id = $1"
